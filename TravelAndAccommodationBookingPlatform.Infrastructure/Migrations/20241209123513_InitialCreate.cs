        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuestRemarks = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeOfRoom = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    MaxChildrenCapacity = table.Column<int>(type: "int", nullable: false),
                    MaxAdultsCapacity = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountAppliedAtBooking = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    PriceAtReservation = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    AmountAfterDiscount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    TaxAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    AdditionalCharges = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InvoiceDetail_Bookings_BookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceDetail_BookingId",
                table: "InvoiceDetail",
                column: "BookingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomClasses_NightlyRate",
                table: "RoomClasses",
                column: "NightlyRate");

            migrationBuilder.CreateIndex(
                name: "IX_RoomClasses_TypeOfRoom",
                table: "RoomClasses",
                column: "TypeOfRoom");
